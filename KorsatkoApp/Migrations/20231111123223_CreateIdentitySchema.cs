    ...
    public partial class CreateIdentitySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ageOlderThan = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    student = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    gender = table.Column<string>(type: "varchar(1)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ageYoungerThan = table.Column<int>(type: "int", nullable: false),
                    course = table.Column<int>(type: "int", nullable: false),
                    session = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchViewModel", x => x.ageOlderThan);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersViewModel", x => x.FullName);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceRate = table.Column<float>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollments", x => new { x.StudentId, x.SessionId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 123, new DateTime(2023, 11, 11, 14, 32, 23, 412, DateTimeKind.Local).AddTicks(2530), "C++ Programming Language for Advanced Programmers", "Advanced C++", null, "C Course", 1500.0 },
                    { 124, new DateTime(2023, 11, 11, 14, 32, 23, 412, DateTimeKind.Local).AddTicks(2534), "C Programming Language", "C For Beginners", null, "None", 1200.0 }
                });
